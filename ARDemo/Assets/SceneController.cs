...
namespace UnityEngine.XR.iOS
{
	public class SceneController : MonoBehaviour
	{
		...
		void Start () {
			unityARAnchorManager = GameObject.FindWithTag("Respawn").GetComponent<UnityARGeneratePlane>().unityARAnchorManager;
		}

		public void Spawn() {
			UnityARUtility.InitializePlanePrefab (scenePrefab);
			Debug.Log ("da");
		}
